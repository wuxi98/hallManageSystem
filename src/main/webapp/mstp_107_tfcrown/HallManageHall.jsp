...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        <li class="charts"><a href="HallManagerIndex.jsp" title=""  ><span>上下机操作</span></a></li>
        <%--   <li class="charts"><a href="#" title=""><span>时间段设置</span></a></li>--%>
        <li class="ui"><a href="../mstp_107_tfcrown/HallManageHall.jsp" title="" class="active"><span>机房管理</span></a></li>
    </ul>
</div>
