...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        <li class="dash"><a href="" title="" ><span>加油！少年</span></a></li>
        <li class="charts"><a href="" title=""  ><span>2019啦！</span></a></li>
        <%--   <li class="charts"><a href="#" title=""><span>时间段设置</span></a></li>--%>
        <li class="ui"><a href="" title=""><span>大家嗨皮！</span></a></li>
    </ul>
</div>
...
<div id="rightSide">
    ...
    <div class="statsRow">
        <div class="wrapper">
            <div class="controlB">
                <ul>
                    <li><a onclick="selectStudentLog()" title=""><img
                            src="<%=basePath %>images/icons/control/32/database.png" alt=""/>
                        <span>查询上机日志</span></a></li>

                    <li><a onclick="selectInfo()" title="">
